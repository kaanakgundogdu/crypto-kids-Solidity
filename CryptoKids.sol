...
contract CryptoKids {
    ...
    event LogKidFundingReceived(address addr,uint amoun, uint contractBalance);
    ...
    function addKid(address payable walletAddress,string memory firstName,string memory lastName,uint releaseTime,uint amount,bool canWithdraw) 
    public onlyOwner{
        kids.push(Kid(
